...
interface TodayClientProps {
  initialNextTasksData: DashboardNextTasksResponse | null;
}

export default function TodayPage({ initialNextTasksData }: TodayClientProps) {
  ...
  const { data: nextTasksData, isFetched: isNextTasksFetched, isLoading, isError, error } = useQuery<DashboardNextTasksResponse>({
    ...
    ...(initialNextTasksData ? { initialData: initialNextTasksData } : {}),
  });
