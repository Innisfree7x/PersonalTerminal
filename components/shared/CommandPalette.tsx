  ...
  const navigationCommands = useMemo<CommandItem[]>(
    () => [
      ...
      },
      {
        ...
        icon: Target,
        action: () => router.push('/workspace/goals'),
      ...
      },
      {
        ...
        icon: Briefcase,
        action: () => router.push('/career/applications'),
      ...
      },
      {
        ...
        icon: GraduationCap,
        action: () => router.push('/uni/courses'),
      ...
      },
      {
        ...
        icon: BarChart3,
        action: () => router.push('/reflect/analytics'),
      ...
      },
      {
        ...
        icon: Route,
        action: () => router.push('/career/trajectory'),
  ...
  const quickActions = useMemo<CommandItem[]>(
    () => [
      ...
      },
      {
        ...
        icon: Plus,
        action: () => triggerPageAction('/career/applications', 'open-new-application'),
      ...
      },
      {
        ...
        icon: Plus,
        action: () => triggerPageAction('/uni/courses', 'open-new-course'),
