...
export function TodayMockup() {
  return (
    <div className="px-5 py-6 md:px-7 md:py-8">
      {/* Morning Briefing */}
      <motion.div
        className="relative mb-6 overflow-hidden rounded-xl border border-primary/15 bg-primary/[0.04] px-4 py-3"
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.1 }}
      >
        <div className="absolute inset-y-0 left-0 w-1 rounded-r-full bg-primary/60" />
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-[10px] font-semibold uppercase tracking-wider text-primary/70">Morning Briefing</span>
        </div>
        <p className="mt-1.5 text-[12px] leading-relaxed text-zinc-400">
          GMAT <span className="font-semibold text-emerald-400">on track</span> · Thesis <span className="font-semibold text-primary">tight</span> · Heute: 4.2h eingeplant · 2 Ziele aktiv
        </p>
      </motion.div>
        ...
        >
          <div className="mb-1.5 flex items-center gap-2">
            <div className="flex h-4 w-4 items-center justify-center rounded bg-primary/15">
              <svg className="h-2.5 w-2.5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                <path d="M13 17l5-5-5-5M6 17l5-5-5-5" />
              </svg>
            </div>
            <span className="font-mono text-[10px] font-medium uppercase tracking-wider text-zinc-600">Next Move</span>
          </div>
          <div className="rounded-xl border border-primary/12 bg-white/[0.02] px-4 py-3">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[11px] font-semibold text-zinc-400 uppercase tracking-widest">Analytics</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono text-[9px] text-zinc-600 uppercase">Momentum</span>
            <span className="font-mono text-[14px] font-bold text-primary">73</span>
            <span className="font-mono text-[10px] font-semibold text-emerald-400">+4</span>
          </div>
        </div>
              ...
              >
                <div className="mb-1 flex items-center justify-between">
                  ...
                  <span className={`text-[11px] font-medium ${complete ? 'text-emerald-400' : 'text-zinc-500'}`}>
                    {complete ? 'Fertig' : `${mod.done}/${mod.total}`}
                  </span>
                </div>
