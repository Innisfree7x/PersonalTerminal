...
Stand: 2026-03-23 (post Marketing Art Direction)
Status: Active
...
4. `docs/PHASE39_MARKETING_ART_DIRECTION_2026-03-23.md` (aktive Landing ueber `CinematicLanding`, asymmetrischer Hero, Proof-Layer und premium Art Direction)
5. `docs/PHASE38_CAREER_INTELLIGENCE_V3_2026-03-22.md` (Company Lens + Recovery Playbook + tieferes Career Dossier)
6. `docs/PHASE37_CRITICAL_PATH_INTEGRATION_2026-03-21.md` (Today/Career/Trajectory-Integrationstests + Coverage-Lift)
7. `docs/PHASE36_QUALITY_HARDENING_2026-03-21.md` (Green Baseline + Coverage-Gate + Type-Hardening)
8. `docs/PHASE35_CAREER_INTELLIGENCE_V2_2026-03-21.md` (CV-Signal, Recovery-State, Action-Stack)
9. `docs/PHASE34_CAREER_DOSSIER_2026-03-19.md` (Career Dossier / Decision Surface)
9. `docs/PHASE33_SHOWCASE_AND_CAREER_BRIDGE_2026-03-19.md` (proof-first Showcase + Career->Trajectory)
10. `docs/PHASE32_MARKETING_CONVERSION_AND_CAREER_TRUST_2026-03-19.md` (Marketing Conversion + Career Trust)
11. `docs/PHASE31_CAREER_HARDENING_2026-03-15.md` (Rate-Limits + LLM-Budget-Guard + Gap->Task-Bridge)
12. `docs/PHASE31_MARKETING_PREMIUM_REFRESH_2026-03-15.md` (verbindliche Marketing-Designphilosophie + Relaunch-Richtung)
13. `docs/PHASE20_MARKETING_DASHBOARD_POLISH.md` (Tab-by-Tab Premium-Polish + Marketing-Contract)
14. `docs/PHASE19_MOMENTUM_SOUND_EXECUTION_CONTRACT.md` (verbindlicher Scope + AC + cooldown/ops gates)
15. `docs/PHASE19_DESIGN_ELEVATION.md` (visueller Contract fuer Dashboard/CommandRail Glass-Layer)
16. `docs/PHASE19_PREMIUM_POLISH.md` (Dashboard-Premium-Polish Contract)
17. `docs/PHASE19_RELEASE_AUDIT_2026-03-07.md` (Ist-Stand, Verifikation, bekannte Risiken)
18. `docs/PHASE18_ACTIVATION_CONVERSION_WAVES.md` (shared risk model, interactive hero, risk-to-action bridge, signup segmentation)
19. `docs/PHASE17_BLOCK3_ACTIVATION_AND_BRIDGE.md` (Onboarding/Today/Trajectory Bridge + contract updates)
20. `docs/PHASE17_AI_GUARDRAILS_EVALS.md` (AI-runtime guardrails + eval gate)
21. `docs/PHASE14_RELIABILITY_OPS.md` (aktueller Reliability-Ausfuehrungsstand inkl. Blocker)
22. `docs/PHASE16_FOCUS_OAUTH_SEARCH_IMPROVEMENTS.md` (aktueller Scope + AC fuer Focus/OAuth/Search)
23. `docs/PHASE16_AUDIT_2026-03-03.md` (Verifikation, Risiken, Handoff)
24. `docs/PHASE13.md` (abgeschlossene Gate-Struktur als Referenz)
25. `docs/PHASE13_RELEASE_AUDIT_2026-02-28.md` (Release-Gate Historie + QA-Kontext)
26. `docs/PHASE12_MASTERPLAN.md` (strategischer Parent)
27. `docs/PHASE12_EXECUTION_BLUEPRINT.md` (Execution-Baseline Tracks 3/4/5/6)
28. `docs/PHASE11_TRACK6_IMPLEMENTATION.md` (Reliability-Basis)
29. `docs/RELEASE_CHECKLIST.md`
30. `.github/workflows/ci.yml` (enforced quality gates incl. production build + eval suite + coverage gate)
31. `docs/GO_LIVE_RUNBOOK.md`
32. `CLAUDE.md` + `llms.txt` / `llms-full.txt` (nur als Assistenz-Kontext)
33. Historische Phase-Dokumente (nur Referenz, nicht normativ)
