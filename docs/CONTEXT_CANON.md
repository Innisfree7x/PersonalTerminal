...
Stand: 2026-03-22 (post Career Intelligence V3)
Status: Active
...
4. `docs/PHASE38_CAREER_INTELLIGENCE_V3_2026-03-22.md` (Company Lens + Recovery Playbook + tieferes Career Dossier)
5. `docs/PHASE37_CRITICAL_PATH_INTEGRATION_2026-03-21.md` (Today/Career/Trajectory-Integrationstests + Coverage-Lift)
6. `docs/PHASE36_QUALITY_HARDENING_2026-03-21.md` (Green Baseline + Coverage-Gate + Type-Hardening)
7. `docs/PHASE35_CAREER_INTELLIGENCE_V2_2026-03-21.md` (CV-Signal, Recovery-State, Action-Stack)
8. `docs/PHASE34_CAREER_DOSSIER_2026-03-19.md` (Career Dossier / Decision Surface)
